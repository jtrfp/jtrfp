...
import org.jtrfp.jtrfp.lvl.jfdt.LVLFile.LevelType;

public class LVLFileTest extends AbstractParserTest<LVLFile> {
    ...
    @Override
    protected LVLFile generateSubject(InputStream is) throws Exception {
	return new LVLFile(is);
    }

    @Override
    protected String getResourceString() {
	return "/org/jtrfp/jtrfp/lvl/jfdt/test.LVL";
    }
