...
public class SITFileCARTTest extends AbstractParserTest<SITFile> {
	...
	assertEquals(2,subject.getNumVehicles());
    }
	...
	int numVehicles;
	assertEquals(2,numVehicles = subject.getNumVehicles());
	...
	assertEquals(0,subject.getNumRamps());
    }
    
    @Test
    public void testRampsPresent() {
	assertNull(subject.getRamps());
    }
    ...
    @Test
    public void testBackdrop0() {
	assertEquals("testBackdrop0.bin",subject.getBackdropModelBINFiles().get(0));
    }
    
    @Test
    public void testBackdrop1() {
	assertEquals("testBackdrop1.bin",subject.getBackdropModelBINFiles().get(1));
    }
    
    @Test
    public void testBackdrop2() {
	assertEquals("testBackdrop2.bin",subject.getBackdropModelBINFiles().get(2));
    }
    
    @Test
    public void testVarlows() {
	assertNotNull(subject.getVarlowEntries());
    }
    
    @Test
    public void testVarlowCount() {
	assertEquals(9,subject.getVarlowEntries().size());
    }
    
    @Test
    public void testVarlowValues() {
	for(int i = 0 ; i < 9; i++) {
	    assertEquals("index="+i, i, subject.getVarlowEntries().get(i).getUnknownInt());
	    assertEquals("index="+i, 1.1, subject.getVarlowEntries().get(i).getX());
	    assertEquals("index="+i, 2.2, subject.getVarlowEntries().get(i).getY());
	    assertEquals("index="+i, 3.3, subject.getVarlowEntries().get(i).getZ());
	}
    }
	...
	return "/org/jtrfp/jtrfp/sit/jfdt/CARTTest.SIT";
    }
