...
public class SITFileMTM1Test extends AbstractParserTest<SITFile> {
    ...
    @Test
    public void testGetTrackLocale() {
	assertEquals("Nowhere, Nowhere",subject.getRaceTrackLocale());
    }
    ...
    @Test
    public void testGetTrackMapBMP() {
	assertEquals("testTrackMap.bmp",subject.getTrackMapBMP());
    }
    
    @Test
    public void testGetTrackFlyByAVI() {
	assertEquals("testTrackFlyBy.avi",subject.getTrackFlybyAVI());
    }
    
    @Test
    public void testGetAnnouncerWAV() {
	assertEquals("testTrackAnnouncer.wav",subject.getTrackAnnouncerWAV());
    }
    
    @Test
    public void testGetTrackDescriptionTXT() {
	assertEquals("testTrackDescription.txt",subject.getTrackDescriptionTXT());
    }
...
///////
  ...
  @Test
  public void testVehicleGetTotalRaceTime() {
	final List<Vehicle> vehicles = subject.getVehicles();
	for(int i = 0; i < vehicles.size(); i++) {
	    final Vehicle v = vehicles.get(i);
	    assertEquals("index "+i,1.1,v.getTotalRaceTime());
	}
  }
  
  @Test
  public void testVehicleGetFastestLap() {
	final List<Vehicle> vehicles = subject.getVehicles();
	for(int i = 0; i < vehicles.size(); i++) {
	    final Vehicle v = vehicles.get(i);
	    assertEquals("index "+i,2.2,v.getFastestLap());
	}
  }
  
  @Test
  public void testVehicleGetDragTimer() {
	final List<Vehicle> vehicles = subject.getVehicles();
	for(int i = 0; i < vehicles.size(); i++) {
	    final Vehicle v = vehicles.get(i);
	    assertEquals("index "+i,3.3,v.getDragTimer());
	}
  }
  ...
  ////
    ...
    //TODO: Cylinders, Boxes, Courses, Stadiums, etc
    @Test
    ...
    @Test
    public void testFirstBoxUnknown1() {
	assertEquals(8,subject.getBoxes().get(0).getUnknown1());
    }
    
    @Test
    public void testFirstBoxUnknown2() {
	assertEquals(9,subject.getBoxes().get(0).getUnknown2());
    }
    
    // RAMPS
    
    @Test
    public void testNumRamps() {
	assertEquals(6,subject.getNumRamps());
    }
    
    @Test
    public void testRampsPresent() {
	assertNotNull(subject.getRamps());
    }
    
    @Test
    public void testFirstRampPosX() {
	assertEquals(1.1,subject.getRamps().get(0).getPosX());
    }
    
    @Test
    public void testFirstRampPosY() {
	assertEquals(2.2,subject.getRamps().get(0).getPosY());
    }
    
    @Test
    public void testFirstRampPosZ() {
	assertEquals(3.3,subject.getRamps().get(0).getPosZ());
    }
    
    @Test
    public void testFirstRampTheta() {
	assertEquals(4.4,subject.getRamps().get(0).getTheta());
    }
    
    @Test
    public void testFirstRampPhi() {
	assertEquals(5.5,subject.getRamps().get(0).getPhi());
    }
    
    @Test
    public void testFirstRampPsi() {
	assertEquals(6.6,subject.getRamps().get(0).getPsi());
    }
    
    @Test
    public void testFirstRampModel() {
	assertEquals("testModel.bin",subject.getRamps().get(0).getModelBINFile());
    }
    
    @Test
    public void testFirstRampMass() {
	assertEquals(-1.1,subject.getRamps().get(0).getMass());
    }
    
    @Test
    public void testFirstRampBVelX() {
	assertEquals(-2.2,subject.getRamps().get(0).getVelX());
    }
    
    @Test
    public void testFirstRampBVelY() {
	assertEquals(-3.3,subject.getRamps().get(0).getVelY());
    }
    
    @Test
    public void testFirstRampBVelZ() {
	assertEquals(-4.4,subject.getRamps().get(0).getVelZ());
    }
    
    @Test
    public void testFirstRampP() {
	assertEquals(5.5,subject.getRamps().get(0).getP());
    }
    
    @Test
    public void testFirstRampQ() {
	assertEquals(6.6,subject.getRamps().get(0).getQ());
    }
    
    @Test
    public void testFirstRampR() {
	assertEquals(7.7,subject.getRamps().get(0).getR());
    }
    
    // COURSES
    @Test
    public void testNumCourseSegments() {
	assertEquals(13,subject.getNumCourseSegments());
    }
	...
	return "/org/jtrfp/jtrfp/sit/jfdt/MTM1Test.SIT";
    }
