...
import org.jtrfp.jtrfp.raw.AbstractIRawDataTest;
import org.jtrfp.jtrfp.raw.IRawData;

public class RAWAdapterTest extends AbstractIRawDataTest {

    @Override
    protected IRawData getSubject() {
	try {return new RAWAdapter(new RAWFile(getInputStream()));}
