...
public abstract class BINFile implements ThirdPartyParseable {
	...
	public static class DataBlock {
		...
		@Override
		protected Class<? extends FaceBlockVertex> getFaceBlockVertexType() {
		    return FaceBlockVertexWithUV.class;//XXX: Not really known.
		}
...
/*
		...
		*/
		...
		public void describeFormat(Parser prs) {
		    ...
		    for (int i = 0; i < getNumVertices(); i++) {
			prs.subParseProposedClasses(prs.indexedProperty(
				"vertices", org.jtrfp.jtrfp.bin.jfdt.BINFile.Model.DataBlock.FaceBlock.FaceBlockVertexWithUV.class, i),
				ClassInclusion
					.classOf(org.jtrfp.jtrfp.bin.jfdt.BINFile.Model.DataBlock.FaceBlock.FaceBlockVertexWithUV.class));
		    }//end for(vertices)
