...
/**
 * Read/Write parser for Terminal Reality NAV asset file, Hellbender formats only.
 * See TVF3NAVFile for Terminal Velocity and Fury3 formats. These files are used
